...
const mixedNum = [6,3,1,7,5,2,6,8,9,4,2,7,9,3,1,8,4,3];
...
//Code Here
let evenNum = mixedNum.filter(element => element%2 === 0);
console.log(evenNum);
...
let orderTotals = orders.map(newPrice => newPrice.price*(1+newPrice.tax))
console.log(orderTotals)


// ////////// PROBLEM 6 ////////// NEED CLARIFICATION ON THIS
...
// let bobsTotal = purchases.reduce((a,c)=>a.price+c.price)
...
//   //Code Here
  ...
  */
  ...
  function largeNumbers({first, second, third}=obj){
    let numArr=[first, second, third];
    numArr.sort(function(a,b){return a-b});
    return lowest = numArr[0];
    }
  ...
  */
  ...
  console.log(numberGroups(numArray))
